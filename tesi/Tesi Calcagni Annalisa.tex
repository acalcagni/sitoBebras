...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=12cm]{./immagini/02_Cap2/02_SitoIndicazioni}} \label{indicazioniNazionali}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=15.0cm]{./immagini/03_Cap3/App_CT}}
