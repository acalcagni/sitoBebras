...
\begin{itemize}
	...
	Se una struttura di dati viene utilizzata per rappresentare una proprietà intrinseca dei dati (ad esempio grafi per relazioni binarie, alberi per reazioni gerarchiche), il quesito viene classificato più adeguatamente all'interno della ``Rappresentazione digitale dell'informazione''.
		...
		\begin{figure}[h]
		\centering
		\fbox{\includegraphics[width=15.0cm]{./immagini/03_Cap3/agenzia_viaggio}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=14.8cm]{./immagini/03_Cap3/scheda1}}
	\caption{``Scheda intervista per gli insegnanti (frammento 1)}\label{robot}
\end{figure}

\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=14.8cm]{./immagini/03_Cap3/scheda2}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=14cm]{./immagini/Appendice/App_elencoQuesiti}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=13.6cm]{./immagini/Appendice/02_SitoIndicazioni}} \label{indicazioniNazionali}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=13.6cm]{./immagini/Appendice/App_CT}}
